...
export const WEAVE_DOMAIN_KNOWLEDGE = [
  ...
  "   frames inside frames for sub-structure (a column that itself stacks a title + body). DO NOT hand-place the",
  "   CONTENT (text, content images, data, cards) on the slide root with hand-picked x/y — content lives in the",
  "   nested layout frames. This mandate governs CONTENT layout; it does NOT block graphics: a BACKDROP or",
