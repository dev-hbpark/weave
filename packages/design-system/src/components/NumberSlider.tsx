...
export const NumberSlider = forwardRef<HTMLDivElement, NumberSliderProps>(
    ...
    return (
      ...
      >
        <SliderPrimitive.Root
          ...
          className={cn(
            "relative flex flex-1 items-center select-none touch-none h-5",
          )}
        >
          ...
          >
            <SliderPrimitive.Range
              className={cn("absolute h-full bg-[color:var(--accent)]")}
            />
          </SliderPrimitive.Track>
