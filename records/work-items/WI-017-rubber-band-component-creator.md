...
- 2026-05-23: **Phase G — Option modifier + empty-space hover hint (재오픈 → 즉시 close)** — 사용자 요청 (2026-05-23) 2 항: (1) Option(⌥) 키를 누른 채 드래그하면 아이템 selection 이 아닌 drag-to-add 가 동작, (2) 빈 영역 hover 시 "여기서 드래그하여 추가" 설명 popup 의 출력 (다른 hover tooltip 들 과 동일한 패턴). **구현**: `useRubberBand` 의 `hostProps` 의 `onPointerDownCapture` 추가 — capture-phase 의 의 의 의 의 child handler 의 의 의 의 의 의 의 의 의 의 의 fire 의 의 의 의 의 의 Alt-held drag 의 의 의 의 hijack (stopPropagation + preventDefault) + 의 의 startDrawing. 의 의 `e.target === e.currentTarget` guard 의 의 의 의 Alt 의 의 의 의 의 의 의 의 의 의 의 의 wired (capture path 의 의 의 의 의무 — bubble path 의 의 의 의 동일 guard 의 의 의 의 의 의 의 의 의 보존). 의 의 `useRubberBand` 의 의 의 `altActive` / `hoverPoint` (client px) state 의 의 새 추가 — 의 의 의 global keydown/keyup 의 의 의 idle 상태 의 의 의 Alt 의 tracking + onPointerMove 의 의 의 onEmpty 의 의 의 의 Alt 의 의 의 hoverPoint 의 의 update. `InsertableCapability` 의 의 `describeHover(ctx)` 의 의 의 의무 (optional, fallback 의 의 의 generic 메시지) — 3 adapter (design-root: 4 도메인 chip / canvas-design: 4 shape chip / block-doc: 3 paragraph chip) 의 의 의 implementation. 새 file `EmptySpaceHint.tsx` — Popover + virtual ref (1×1 의 의 cursor 의 anchor) + aurora-glass surface + title / hint paragraph / ⌥ drag kbd badge (altActive 시 accent 의 의 의 의 highlight) / kinds chip list + `pointerEvents: "none"` (의 의 의 의 의 의 의 drag 의 의 의 의 intercept 의 의 의 의무). RubberBandLayer 의 의 의 새 hostProps fields (`onPointerDownCapture` / `onPointerLeave`) wire + 의 의 의 의 의 `data-rubber-band-alt-active` 의 의 의 의 의 cursor (`crosshair` while drawing, `copy` while Alt 의 의 의 의 의 의 의 의). **Verification**: typecheck (양 패키지) PASS + unit 56/56 + **55/55 e2e (1 skip) PASS** (의 의 의 의 의 의 의 의 의 의 의 의 회귀 0) + workspace validator 67/27/27 + **dev server 의 의 visual smoke**: (1) 빈 영역 hover → 의 의 의 의 hint popover 의 의 의 (title "이 캔버스에 프레임 추가" + 4 kind chip + ⌥ drag kbd) 의 의 의 의 의 의 render, (2) Option (Alt) hold + frame 위 드래그 → host state "drawing" 의 의 의 의 의 의 의 의 의 의 의 의 의 popover 의 의 의 의 의 wide-* 의 의 의 recommendation 의 출력, (3) Alt kbd badge 의 의 의 의 active accent 의 의 의 의 의 visual toggle 의 의 의 confirm. WI-017 의 의 의 의 의 의 의 의 의 의 의 의 의 의 close 의 의 의 의 의 의 의 의 의 의 의 reopen 의 의 의 같은 의 의 의 의 의 의 의 의 close (의 의 의 의 phase 추가). 
